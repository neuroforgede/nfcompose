...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('dataseries', '0017_partitions_by_uuid'),
    ]
    ...
    operations = [
        ...
        migrations.AddConstraint(
            model_name='partitionsbyuuid',
            constraint=models.UniqueConstraint(fields=('child_table', 'partition_key'), name='_3_partitions_by_uuid_child_table_partition_key'),
        ),
        ...
        migrations.AlterModelTable(
            ...
            table='_3_partition_by_uuid',
        ),
        migrations.RenameModel(
            old_name='PartitionsByUUID',
            new_name='PartitionByUUID',
        ),
        migrations.RemoveConstraint(
            model_name='partitionbyuuid',
            name='_3_partitions_by_uuid_base_table_partition_key',
        ),
        migrations.RemoveConstraint(
            model_name='partitionbyuuid',
            name='_3_partitions_by_uuid_child_table_partition_key',
        ),
        migrations.AddConstraint(
            model_name='partitionbyuuid',
            constraint=models.UniqueConstraint(fields=('base_table', 'partition_key'), name='_3_partition_by_uuid_base_table_partition_key'),
        ),
        migrations.AddConstraint(
            model_name='partitionbyuuid',
            constraint=models.UniqueConstraint(fields=('child_table', 'partition_key'), name='_3_partition_by_uuid_child_table_partition_key'),
        ),
    ]
