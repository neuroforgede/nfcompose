...
class GETDataSeriesChildListPermissionUsersPermissionTest(BaseDataSeriesDetailPermissionTest):
    ...
    def method_under_test_proper(self) -> Union[HttpResponse, TestHttpResponse]:
        return cast(TestHttpResponse, self.user_client.get(
            path=self.data_series_json['permission_user'],
            format='json'
        ))


class POSTDataSeriesChildListPermissionUsersPermissionTest(BaseDataSeriesDetailPermissionTest):
...
class PUTDataSeriesChildListPermissionUsersPermissionTest(BaseDataSeriesDetailPermissionTest):
...
class PATCHDataSeriesChildListPermissionUsersPermissionTest(BaseDataSeriesDetailPermissionTest):
...
class HEADDataSeriesChildListPermissionUsersPermissionTest(BaseDataSeriesDetailPermissionTest):
...
class OPTIONSDataSeriesChildListPermissionUsersPermissionTest(BaseDataSeriesDetailPermissionTest):
...
class DELETEDDataSeriesChildListPermissionUsersPermissionTest(BaseDataSeriesDetailPermissionTest):
