...
class BaseDataSeriesChildDetailPermissionTest(BaseRESTPermissionTest):
    """
    ...
    data_series_detail_sub_element_json: Dict[str, Any]

    base_class_name = 'BaseDataSeriesChildDetailPermissionTest'
    ...
    def base_add_bare_user(self) -> None:
        ...
        self.create_detail_sub_element()
