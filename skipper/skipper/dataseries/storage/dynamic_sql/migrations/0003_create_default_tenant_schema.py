...
def migrations_for_datapoint_data_tables(data_name: str, data_foreign_key: str, fact_or_dim_id: str = 'fact_id', value_name: str = 'value') -> List[migrations.operations.base.Operation]:
