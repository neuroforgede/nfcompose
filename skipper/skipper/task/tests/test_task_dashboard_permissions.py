...
TASK_BASE_URL = BASE_URL + modules.url_representation(modules.Module.TASK) + '/'


class TaskDashboardPermissionTest(BaseViewTest):
    url_under_test = TASK_BASE_URL + 'dashboard/'
